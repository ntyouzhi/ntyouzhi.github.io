(() => {
  const domains = {
    ...
    tech: {
      ...
      intro: "当前已开放自行车、联合收割机与手摇卷笔刀结构探索，通过整机观察、部件标注和系统演示，理解技术产品怎样由多个子系统协同工作。",
      color: "#b06f3c",
      topics: [
        ["自行车结构探索", "已开放", "观察部件、力与运动以及五个基本系统的协同关系", "open"],
        ["联合收割机结构探索", "已开放", "沿收割、脱粒、分离、集粮流程观察农业机械系统", "open"],
        ["手摇卷笔刀结构与功能", "已开放", "观察夹持、推进、传动、切削与收屑的协同工作", "open"]
      ]
    }
  };
